...
_CATEGORY_RULES_BUILTIN = [
    ...
    ("Pneumatic",           [r"pneumatic", r"air.?cylinder", r"\bcylinder\b",
                             r"bimba", r"\bsmc\b", r"festo", r"\bsolenoid\b"]),
    ("Robot / Arm",         [r"\brobot\b", r"manipulator", r"m-?16ib", r"fanuc",
                             r"\baxis[0-9]", r"rj3ib", r"\bkuka\b", r"\babb\b", r"yaskawa"]),
    ("Bearings",            [r"\bbearing\b", r"\b6[0-9]{3}\b"]),
    ("Gears",               [r"\bgear\b", r"pinion"]),
    ("Linear Motion",       [r"linear.*(guide|rail|stage)", r"\blm.?guide\b",
                             r"ball.?screw", r"lead.?screw", r"\bbsj\b", r"nook",
                             r"\bthk\b", r"hiwin", r"\bslide\b", r"\brail\b"]),
    ("Grippers",            [r"gripper", r"schunk", r"\bpsh\b", r"\bclamp\b"]),
    ("Welding",             [r"\btig\b", r"\bmig\b", r"weld", r"torch", r"\bgun\b"]),
    ("Fasteners",           [r"\bbolt\b", r"\bnut\b", r"\bwasher\b", r"\bunf\b",
                             r"\bunc\b", r"\bm[0-9]+x[0-9]"]),
